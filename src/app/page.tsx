      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center px-4 py-8 sm:px-6 sm:py-12">
        ...
        <section className="w-full max-w-3xl">
          <div className="terminal-card fade-in flex min-h-[30rem] flex-col overflow-hidden sm:h-[34rem] lg:h-[36rem]">
            <div className="terminal-header mb-5 flex items-center justify-between border-b border-[#4B2E9E]/10 pb-3 sm:mb-6 sm:pb-4">
              <div className="flex items-center gap-2">
                <span className="h-3 w-3 rounded-full bg-[#ff5f57]" />
                <span className="h-3 w-3 rounded-full bg-[#febc2e]" />
                <span className="h-3 w-3 rounded-full bg-[#28c840]" />
              </div>
              <div className="terminal-header-title text-xs text-[#4B2E9E]/70">
                mini-hackathon-2026 — bash — 80x24
              </div>
              <div className="h-3 w-12" aria-hidden="true" />
            </div>
            ...
            <div className="mt-7 border-t border-[#4B2E9E]/10 pt-6 text-center sm:mt-8 sm:pt-8">
              <p className="font-terminal text-[clamp(2.6rem,15vw,6.5rem)] font-black tracking-[-0.08em] sm:text-[clamp(3rem,11vw,6.5rem)]">
                <span className="hero-gradient">{shownHeroText || "\u00A0"}</span>
